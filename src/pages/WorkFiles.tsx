...
export default function WorkFiles() {
  ...
  const deleteFile = async (file: WorkFile) => {
  ...
  const downloadFile = async (file: WorkFile) => {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Work Files</h1>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center mb-4">
              Upload your work documents, reports, and presentations
            </p>
          </CardContent>
        </Card>
      ) : (
